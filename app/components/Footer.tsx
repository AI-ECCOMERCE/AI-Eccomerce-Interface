    ...
    <footer className="bg-slate-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
            ...
            <div className="flex gap-3">
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.34-6.34V8.75a8.23 8.23 0 004.79 1.53V6.84a4.86 4.86 0 01-1.03-.15z" />
                </svg>
              </a>
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display font-bold text-white mb-5">Menu</h4>
          ...
          {/* Products */}
          <div>
            <h4 className="font-display font-bold text-white mb-5">Produk</h4>
            <ul className="space-y-3">
              <li>
                <a href="#products" className="text-slate-400 hover:text-brand-400 text-sm transition-colors">
                  ChatGPT Plus
