          ...
          return (
            <div key={cat.id} className="bg-white rounded-2xl border border-slate-100 p-6 stat-card">
              ...
              <div className="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between">
                ...
                <button onClick={() => handleDelete(cat.id)} className="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all"><i className="ph-duotone ph-trash text-sm"></i></button>
              </div>
            </div>
          );
        })}
